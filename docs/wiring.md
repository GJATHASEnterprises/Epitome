...
[Internal 180W AC/DC PSU Module] ──→ [Main DC Rail: 20V]
          ...
          +---------------------------------+------------------+----------+
          |              |              |              |                  |
   [Qi TX 1]      [Qi TX 2]     [Watch Puck]  [USB-C PD Out]     [3.3V LDO]
   Zone 1 (15W)  Zone 2 (15W)  Zone 3 (5W)   Zone 4 (100W)          |
      |               |              |              |              [ESP32-C3 Mini]
...
| USB-C PD out | 5V–20V (negotiated) | Laptop / tablet / phone |
...
- Total LEDs: 16 (4 per zone); cut from a 60 LED/m reel

---

## Ambient Light Sensor: BH1750

- **Interface:** I2C (same bus as INA3221 + INA219: GPIO 8/9)
...
- Address set via A0/A1 pins — ensure no conflict with INA3221 or BH1750
