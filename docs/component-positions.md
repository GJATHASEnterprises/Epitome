...
> **Zone 5 correction note:** Zone 5 was originally documented at X=+80 which falls outside the tapered top surface. Corrected to X=+64 with groove starting at Y=60 to stay within the enclosure boundary at all depths.
...
| Zone 5 — iPad/Phone groove centre | +64.00 | 150.00 | right-half | 18mm wide spine slot, Y:60..285, silicone-lined |
| Zone 4 — USB-C port (exterior) | +40.00 | 258.00 | 8.00 | Within groove 1, aligned to slot |
| Zone 5 — USB-C port (exterior) | +64.00 | 258.00 | 8.00 | Within groove 2, aligned to slot |
...
| Label: iPAD/PHONE | +64.00 | 95.00 | 18.17 | 6mm etched text |
...
| INA219 Zone 5 | +64.00 | 150.00 | 8.50 | 8×8 on PCB near Zone 5 PD branch |
...
| USB-C PD 20W board (Zone 5) | +64.00 | 150.00 | 5.00 | 30×20, X:+49..+79, Y:135..165 |
| USB-C port (Zone 4, exterior) | +40.00 | 258.00 | 8.00 | Within groove 1, aligned to the spine slot |
| USB-C port (Zone 5, exterior) | +64.00 | 258.00 | 8.00 | Within groove 2, aligned to the spine slot |
...
| Polyfuse Zone 5 | +69.00 | 150.00 | 8.50 | SMD PD branch |
...
| NTC thermistor Zone 5 | +64.00 | 145.00 | 4.50 | Under Zone 5 port area |
...
- **Spacing:** the dock now supports **5 zones** with three parallel guide lines on the right half: laptop at `X=+40` and the new iPad/phone groove at `X=+64`, separated by a 6mm structural wall (Zone 4 right edge X=+51, wall X=+51..+57, Zone 5 left edge X=+57, centre X=+64, right edge X=+71).
