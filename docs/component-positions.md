...
| Zone 4 — Laptop groove | +50.00 | 150.00 | right-half centered | Full right-half vertical groove zone, 22mm spine slot, Y:15..285 |
...
| Label: LAPTOP | +50.00 | 95.00 | 18.17 | 6mm etched text |
...
| INA219 | 0.00 | 110.00 | 8.50 | 8×8 on PCB near PD branch |
...
| USB-C PD board | +50.00 | 150.00 | 5.00 | 40×30, X:+30..+70, Y:135..165 |
| USB-C port (Zone 4, exterior) | +50.00 | 258.00 | 8.00 | Within right-half groove zone, aligned to the spine slot |
...
- **Spacing:** left-half charging zones are vertically stacked for clearer reach hierarchy while the laptop occupies the full right half.
