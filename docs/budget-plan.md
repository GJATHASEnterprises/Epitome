...
| Item | Amount | Notes |
|---|---:|---|
| Batch 1 Step parts + packaging + build consumables | ~$430 | 3 Walnut + 3 Obsidian plan |
...
- Batch 1 projected profit (**~$225–240**) will **not** fully recoup the **$150–250 CAD spend**, and that is an accepted validation cost rather than a launch failure.
