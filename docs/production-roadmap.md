...
- Profit target: **~$225–240**

### Week 1 additions

1. Measurement order (~$35): one of each electronics module for caliper capture.
2. Consolidated parts order after measurements (~$430 Step-only, or ~$740 full 10-unit planning envelope).
